...
/**
 * EndorphinaDirect — direct Endorphina demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class EndorphinaDirect implements SourceInterface
{
    public function id(): string { return 'endorphina'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://endorphina.com/games/{slug}/play';
