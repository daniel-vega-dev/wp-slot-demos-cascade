...
/**
 * RelaxCdnDirect — direct Relax demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class RelaxCdnDirect implements SourceInterface
{
    public function id(): string { return 'relax-cdn'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://d3nsdzdtjbr5ml.cloudfront.net/casino/relax/{slug}/index.html?moneymode=fun';
