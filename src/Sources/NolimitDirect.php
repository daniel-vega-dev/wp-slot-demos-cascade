...
/**
 * NolimitDirect — direct Nolimit demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class NolimitDirect implements SourceInterface
{
    public function id(): string { return 'nolimit'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://www.nolimitcity.com/load-game/?game={game}&device=desktop';
