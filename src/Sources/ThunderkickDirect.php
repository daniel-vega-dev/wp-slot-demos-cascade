...
/**
 * ThunderkickDirect — direct Thunderkick demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class ThunderkickDirect implements SourceInterface
{
    public function id(): string { return 'thunderkick'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://forfun.thunderkick.com/gamelauncher/play/generic?device=desktop&gameId=tk-{slug}&operatorId=2&playMode=demo';
