...
/**
 * YggdrasilDirect — direct Yggdrasil demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class YggdrasilDirect implements SourceInterface
{
    public function id(): string { return 'yggdrasil'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://staticdemo.yggdrasilgaming.com/init/launchClient.html?gameid={id}&lang={locale}&currency=EUR&org=Demo&key=&fullscreen=yes';
