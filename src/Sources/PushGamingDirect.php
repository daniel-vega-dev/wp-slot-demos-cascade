...
/**
 * PushGamingDirect — direct PushGaming demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class PushGamingDirect implements SourceInterface
{
    public function id(): string { return 'push-gaming'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://player.eu.demo.pushgaming.com/mesh/b2c/igp/pg-com/launch?mode=DEMO&country=ES&rgsCode=hive&ccyCode=fun&jurisdiction=NA&rgsGameId={slug}&lang={locale}&lobbyUrl=https%3A%2F%2F{site_url}%2F';
