...
/**
 * QuickspinDirect — direct Quickspin demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class QuickspinDirect implements SourceInterface
{
    public function id(): string { return 'quickspin'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://d10zgitni74b5t.cloudfront.net/casino/launcher.html?channel=web&gameid={slug}&lang={locale}&moneymode=fun&partner=softswisscuracao&partnerid=37';
