...
/**
 * StakelogicDirect — direct Stakelogic demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class StakelogicDirect implements SourceInterface
{
    public function id(): string { return 'stakelogic'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://ngpd.demo-gs-stakelogic.com/demo/play?gameId={id}';
