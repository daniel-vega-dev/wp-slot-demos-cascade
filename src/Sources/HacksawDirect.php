...
/**
 * HacksawDirect — direct Hacksaw demo CDN.
 * Auto-generated from /tmp/new-aggregators.json on 2026-05-07.
 */
class HacksawDirect implements SourceInterface
{
    public function id(): string { return 'hacksaw'; }
    ...
    public function resolve(array $cfg, string $locale = 'es'): array
    {
        ...
        $url = 'https://static-live.hacksawgaming.com/launcher/static-launcher.html?gameid={id}&channel=desktop&language={locale}&partner=bigwinboard&mode=demo&token=123';
